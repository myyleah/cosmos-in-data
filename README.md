...
│   └── etl_load_script.py    # Standalone load utility
├── dash_app/
│   └── app.py                # Plotly Dash dashboard application
├── docs/
│   └── schema_documentation.md  # Database schema documentation
├── images/
│   ├── nasadash.png          # Dashboard screenshot — charts view
│   └── nasadash2.png         # Dashboard screenshot — hero & KPI view
├── README.md
├── requirements.txt
...
```bash
python etl/etl_pipeline_week3.py
```
...
|---|---|
| ![Dashboard top half](images/nasadash2.png) | ![Dashboard charts](images/nasadash.png) |
